        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="inline-block py-4 px-8 rounded-full bg-clight text-[14px] leading-none font-bold tracking-wide uppercase text-cdark hover:bg-caccent"
            >
              Download Resume
            </a>
            <a
              href="https://www.linkedin.com/in/pablofogliazza/"
              className="fill-clight hover:fill-caccent"
